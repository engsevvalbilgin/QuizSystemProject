                    ...
                    {requests.map(request => (
                        <div key={request.id} className="request-card">
                            <div className="request-info">
                                ...
                                <p><strong>Ders Alanı:</strong> {request.subject}</p>
                                <p><strong>Mezun Olduğu Okul:</strong> {request.graduateSchool}</p>
                                <p><strong>Diploma No:</strong> {request.diplomaNo}</p>
                                <p><strong>Başvuru Tarihi:</strong> {new Date(request.createdDate).toLocaleDateString('tr-TR')}</p>
                            </div>
